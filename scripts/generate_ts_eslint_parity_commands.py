...
def main() -> None:
	...
	descriptions = {
		...
		"parity:ts-eslint:diff": "Compare current tracker against baseline (defaults to HEAD~1).",
		"parity:ts-eslint:diff:json": "Compare parity snapshots and emit JSON diff (defaults to HEAD~1).",
