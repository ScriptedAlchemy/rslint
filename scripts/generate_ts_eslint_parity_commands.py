...
def main() -> None:
	...
	descriptions = {
		...
		"parity:ts-eslint:check:strict:yellow": "Run full parity checks and fail if health is yellow or red.",
		"parity:ts-eslint:check:strict:clean": "Run strict gate and require clean parity artifacts for verify-clean.",
		"parity:ts-eslint:check:strict:yellow:clean": "Run yellow strict gate and require clean parity artifacts for verify-clean.",
		...
		"parity:ts-eslint:gate:quick": "Run red-threshold gate only (skip strict clean checks).",
		"parity:ts-eslint:gate:quick:red": "Run red-threshold gate only (skip strict clean checks).",
		"parity:ts-eslint:gate:quick:yellow": "Run yellow-threshold gate only (skip strict clean checks).",
		...
		"parity:ts-eslint:status:strict": "Generate status JSON and fail when health is red.",
		...
		"parity:ts-eslint:doctor:json:strict:yellow": "Print parity doctor JSON and fail if health is yellow or red.",
		"parity:ts-eslint:doctor:strict": "Print parity health diagnosis and fail if critical backlog exists.",
		"parity:ts-eslint:doctor:strict:yellow": "Print parity doctor output and fail if health is yellow or red.",
