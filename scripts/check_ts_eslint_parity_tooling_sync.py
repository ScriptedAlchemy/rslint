...
def main() -> None:
	...
	expected_scripts = {
		...
		"parity:ts-eslint:gate:quick": "run_ts_eslint_parity_gate.sh --threshold red --skip-checks",
		"parity:ts-eslint:gate:quick:red": "run_ts_eslint_parity_gate.sh --threshold red --skip-checks",
		"parity:ts-eslint:gate:quick:yellow": "run_ts_eslint_parity_gate.sh --threshold yellow --skip-checks",
