...
def main() -> None:
	...
	lines.append("pnpm parity:ts-eslint:check:fast")
	lines.append("pnpm parity:ts-eslint:check:all")
	lines.append("pnpm parity:ts-eslint:check:clean")
	...
	lines.append("pnpm parity:ts-eslint:gate:quick")
	lines.append("pnpm parity:ts-eslint:gate:quick:red")
	lines.append("pnpm parity:ts-eslint:gate:quick:yellow")
	...
	lines.append("pnpm parity:ts-eslint:status:strict")
	lines.append("pnpm parity:ts-eslint:status:strict:yellow")
	lines.append("pnpm parity:ts-eslint:ci-summary")
	lines.append("pnpm parity:ts-eslint:ci-summary:json")
	lines.append("pnpm parity:ts-eslint:ci-summary:strict")
	lines.append("pnpm parity:ts-eslint:ci-summary:strict:yellow")
	...
	lines.append("pnpm parity:ts-eslint:doctor:json:strict:yellow")
	lines.append("pnpm parity:ts-eslint:doctor:strict")
	lines.append("pnpm parity:ts-eslint:doctor:strict:yellow")
	lines.append("pnpm parity:ts-eslint:diff")
