...
6. Run consistency check to ensure tracker/summary/worklist/metadata/manifest/index/issue-plan/issue-body artifacts, CI summary output, and CI workflow artifact-bundle wiring remain synchronized.
